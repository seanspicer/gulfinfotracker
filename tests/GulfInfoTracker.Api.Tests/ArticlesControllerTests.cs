...
public class ArticlesControllerTests
{
    ...
    public async Task GetArticles_ReturnsOkWithCorrectEnvelope()
    {
        ...
        var result = await _controller.GetArticles(null, null, null, 1, 20, CancellationToken.None);
    ...
    public async Task GetArticles_TopicFilter_PassedToRepository()
    {
        ...
        await _controller.GetArticles("T3", null, null, 1, 20, CancellationToken.None);
    ...
    public async Task GetArticles_CountryFilter_PassedToRepository()
    {
        ...
        await _controller.GetArticles(null, "UAE", null, 1, 20, CancellationToken.None);
